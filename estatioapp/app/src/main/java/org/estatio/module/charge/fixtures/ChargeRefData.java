...
public class ChargeRefData extends FixtureScript {
    ...
    public static final String IT_RENT = Country_data.ITA.getRef3() + CHARGE_SUFFIX_RENT;
    public static final String IT_SERVICE_CHARGE = Country_data.ITA.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE;
    public static final String IT_TURNOVER_RENT = Country_data.ITA.getRef3() + CHARGE_SUFFIX_TURNOVER_RENT;
    public static final String IT_PERCENTAGE = Country_data.ITA.getRef3() + CHARGE_SUFFIX_PERCENTAGE;
    public static final String IT_DEPOSIT = Country_data.ITA.getRef3() + CHARGE_SUFFIX_DEPOSIT;
    public static final String IT_DISCOUNT = Country_data.ITA.getRef3() + CHARGE_SUFFIX_DISCOUNT;
    public static final String IT_ENTRY_FEE = Country_data.ITA.getRef3() + CHARGE_SUFFIX_ENTRY_FEE;
    public static final String IT_TAX = Country_data.ITA.getRef3() + CHARGE_SUFFIX_TAX;
    public static final String IT_SERVICE_CHARGE_INDEXABLE = Country_data.ITA.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE_INDEXABLE;

    public static final String NL_RENT = Country_data.NLD.getRef3() + CHARGE_SUFFIX_RENT;
    public static final String NL_SERVICE_CHARGE = Country_data.NLD.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE;
    public static final String NL_SERVICE_CHARGE2 = Country_data.NLD.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE2;
    public static final String NL_INCOMING_CHARGE_1 = Country_data.NLD.getRef3() + CHARGE_SUFFIX_INCOMING_CHARGE_1;
    public static final String NL_INCOMING_CHARGE_2 = Country_data.NLD.getRef3() + CHARGE_SUFFIX_INCOMING_CHARGE_2;
    public static final String NL_INCOMING_CHARGE_3 = Country_data.NLD.getRef3() + CHARGE_SUFFIX_INCOMING_CHARGE_3;
    public static final String NL_TURNOVER_RENT = Country_data.NLD.getRef3() + CHARGE_SUFFIX_TURNOVER_RENT;
    public static final String NL_PERCENTAGE = Country_data.NLD.getRef3() + CHARGE_SUFFIX_PERCENTAGE;
    public static final String NL_DEPOSIT = Country_data.NLD.getRef3() + CHARGE_SUFFIX_DEPOSIT;
    public static final String NL_DISCOUNT = Country_data.NLD.getRef3() + CHARGE_SUFFIX_DISCOUNT;
    public static final String NL_ENTRY_FEE = Country_data.NLD.getRef3() + CHARGE_SUFFIX_ENTRY_FEE;
    public static final String NL_TAX = Country_data.NLD.getRef3() + CHARGE_SUFFIX_TAX;
    public static final String NL_SERVICE_CHARGE_INDEXABLE = Country_data.NLD.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE_INDEXABLE;

    public static final String SE_RENT = Country_data.SWE.getRef3() + CHARGE_SUFFIX_RENT;
    public static final String SE_SERVICE_CHARGE = Country_data.SWE.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE;
    public static final String SE_TURNOVER_RENT = Country_data.SWE.getRef3() + CHARGE_SUFFIX_TURNOVER_RENT;
    public static final String SE_PERCENTAGE = Country_data.SWE.getRef3() + CHARGE_SUFFIX_PERCENTAGE;
    public static final String SE_DEPOSIT = Country_data.SWE.getRef3() + CHARGE_SUFFIX_DEPOSIT;
    public static final String SE_DISCOUNT = Country_data.SWE.getRef3() + CHARGE_SUFFIX_DISCOUNT;
    public static final String SE_ENTRY_FEE = Country_data.SWE.getRef3() + CHARGE_SUFFIX_ENTRY_FEE;
    public static final String SE_TAX = Country_data.SWE.getRef3() + CHARGE_SUFFIX_TAX;
    public static final String SE_SERVICE_CHARGE_INDEXABLE = Country_data.SWE.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE_INDEXABLE;

    public static final String FR_RENT = Country_data.FRA.getRef3() + CHARGE_SUFFIX_RENT;
    public static final String FR_SERVICE_CHARGE = Country_data.FRA.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE;
    public static final String FR_SERVICE_CHARGE_ONBUDGET1 = Country_data.FRA.getRef3() + CHARGE_SUFFIX_INCOMING_CHARGE_1;
    public static final String FR_SERVICE_CHARGE_ONBUDGET2 = Country_data.FRA.getRef3() + CHARGE_SUFFIX_INCOMING_CHARGE_2;
    public static final String FR_TURNOVER_RENT = Country_data.FRA.getRef3() + CHARGE_SUFFIX_TURNOVER_RENT;
    public static final String FR_PERCENTAGE = Country_data.FRA.getRef3() + CHARGE_SUFFIX_PERCENTAGE;
    public static final String FR_DEPOSIT = Country_data.FRA.getRef3() + CHARGE_SUFFIX_DEPOSIT;
    public static final String FR_DISCOUNT = Country_data.FRA.getRef3() + CHARGE_SUFFIX_DISCOUNT;
    public static final String FR_ENTRY_FEE = Country_data.FRA.getRef3() + CHARGE_SUFFIX_ENTRY_FEE;
    public static final String FR_TAX = Country_data.FRA.getRef3() + CHARGE_SUFFIX_TAX;
    public static final String FR_SERVICE_CHARGE_INDEXABLE = Country_data.FRA.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE_INDEXABLE;

    public static final String GB_RENT = Country_data.GBR.getRef3() + CHARGE_SUFFIX_RENT;
    public static final String GB_SERVICE_CHARGE = Country_data.GBR.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE;
    public static final String GB_SERVICE_CHARGE2 = Country_data.GBR.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE2;
    public static final String GB_INCOMING_CHARGE_1 = Country_data.GBR.getRef3() + CHARGE_SUFFIX_INCOMING_CHARGE_1;
    public static final String GB_INCOMING_CHARGE_2 = Country_data.GBR.getRef3() + CHARGE_SUFFIX_INCOMING_CHARGE_2;
    public static final String GB_INCOMING_CHARGE_3 = Country_data.GBR.getRef3() + CHARGE_SUFFIX_INCOMING_CHARGE_3;
    public static final String GB_TURNOVER_RENT = Country_data.GBR.getRef3() + CHARGE_SUFFIX_TURNOVER_RENT;
    public static final String GB_PERCENTAGE = Country_data.GBR.getRef3() + CHARGE_SUFFIX_PERCENTAGE;
    public static final String GB_DEPOSIT = Country_data.GBR.getRef3() + CHARGE_SUFFIX_DEPOSIT;
    public static final String GB_DISCOUNT = Country_data.GBR.getRef3() + CHARGE_SUFFIX_DISCOUNT;
    public static final String GB_ENTRY_FEE = Country_data.GBR.getRef3() + CHARGE_SUFFIX_ENTRY_FEE;
    public static final String GB_TAX = Country_data.GBR.getRef3() + CHARGE_SUFFIX_TAX;
    public static final String GB_SERVICE_CHARGE_INDEXABLE = Country_data.GBR.getRef3() + CHARGE_SUFFIX_SERVICE_CHARGE_INDEXABLE;
    public static final String GB_MARKETING = Country_data.GBR.getRef3() + CHARGE_SUFFIX_MARKETING;
