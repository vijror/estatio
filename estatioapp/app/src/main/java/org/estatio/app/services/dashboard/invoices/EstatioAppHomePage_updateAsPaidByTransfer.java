 ...
 */
@Mixin(method = "act")
public class EstatioAppHomePage_updateAsPaidByTransfer {

    private final EstatioAppHomePage homePage;

    public EstatioAppHomePage_updateAsPaidByTransfer(EstatioAppHomePage homePage) {
    ...
    public List<IncomingInvoice> choices0Act() {
        return homePage.getIncomingInvoicesPayableByAlreadyPaid();
    }
